...
set -x
fabric-ca-client enroll -u https://admin:adminpw@${IP}:${PORT} --caname ca-${CA_NAME} --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
{ set +x; } 2>/dev/null
echo "NodeOUs:
  Enable: true
  ClientOUIdentifier:
  ...
  fabric-ca-client register --caname ca-${CA_NAME} --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null

  fabric-ca-client register --caname ca-${CA_NAME} --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null

  fabric-ca-client register --caname ca-${CA_NAME} --id.name orderer0 --id.secret orderer0pw --id.type orderer --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null

  fabric-ca-client register --caname ca-${CA_NAME} --id.name orderer1 --id.secret orderer1pw --id.type orderer --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null

  fabric-ca-client register --caname ca-${CA_NAME} --id.name orderer2 --id.secret orderer2pw --id.type orderer --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null

  echo "Registering user"
  set -x
  fabric-ca-client register --caname ca-${CA_NAME} --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null

  echo "Registering the org admin"
  set -x
  fabric-ca-client register --caname ca-${CA_NAME} --id.name ${ORG_NAME}admin --id.secret ${ORG_NAME}adminpw --id.type admin --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null

  echo "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@${IP}:${PORT} --caname ca-${CA_NAME} -M "${PWD}/crypto-config/organizations/peerOrganizations/${ORG_NAME}/peers/peer0.${ORG_NAME}/msp" --csr.hosts peer0.${ORG_NAME} --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@${IP}:${PORT} --caname ca-${CA_NAME} -M "${PWD}/crypto-config/organizations/peerOrganizations/${ORG_NAME}/peers/peer0.${ORG_NAME}/tls" --enrollment.profile tls --csr.hosts peer0.${ORG_NAME} --csr.hosts ${IP} --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@${IP}:${PORT} --caname ca-${CA_NAME} -M "${PWD}/crypto-config/organizations/peerOrganizations/${ORG_NAME}/peers/peer1.${ORG_NAME}/msp" --csr.hosts peer1.${ORG_NAME} --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@${IP}:${PORT} --caname ca-${CA_NAME} -M "${PWD}/crypto-config/organizations/peerOrganizations/${ORG_NAME}/peers/peer1.${ORG_NAME}/tls" --enrollment.profile tls --csr.hosts peer1.${ORG_NAME} --csr.hosts ${IP} --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer0:orderer0pw@${IP}:${PORT} --caname ca-${CA_NAME} -M "${PWD}/crypto-config/organizations/peerOrganizations/${ORG_NAME}/orderers/orderer0.${ORG_NAME}/msp" --csr.hosts orderer0.${ORG_NAME} --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer0:orderer0pw@${IP}:${PORT} --caname ca-${CA_NAME} -M "${PWD}/crypto-config/organizations/peerOrganizations/${ORG_NAME}/orderers/orderer0.${ORG_NAME}/tls" --enrollment.profile tls --csr.hosts orderer0.${ORG_NAME} --csr.hosts ${IP} --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer1:orderer1pw@${IP}:${PORT} --caname ca-${CA_NAME} -M "${PWD}/crypto-config/organizations/peerOrganizations/${ORG_NAME}/orderers/orderer1.${ORG_NAME}/msp" --csr.hosts orderer1.${ORG_NAME} --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer1:orderer1pw@${IP}:${PORT} --caname ca-${CA_NAME} -M "${PWD}/crypto-config/organizations/peerOrganizations/${ORG_NAME}/orderers/orderer1.${ORG_NAME}/tls" --enrollment.profile tls --csr.hosts orderer1.${ORG_NAME} --csr.hosts ${IP} --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer2:orderer2pw@${IP}:${PORT} --caname ca-${CA_NAME} -M "${PWD}/crypto-config/organizations/peerOrganizations/${ORG_NAME}/orderers/orderer2.${ORG_NAME}/msp" --csr.hosts orderer2.${ORG_NAME} --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer2:orderer2pw@${IP}:${PORT} --caname ca-${CA_NAME} -M "${PWD}/crypto-config/organizations/peerOrganizations/${ORG_NAME}/orderers/orderer2.${ORG_NAME}/tls" --enrollment.profile tls --csr.hosts orderer2.${ORG_NAME} --csr.hosts ${IP} --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@${IP}:${PORT} --caname ca-${CA_NAME} -M "${PWD}/crypto-config/organizations/peerOrganizations/${ORG_NAME}/users/User1@${ORG_NAME}/msp" --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://${ORG_NAME}admin:${ORG_NAME}adminpw@${IP}:${PORT} --caname ca-${CA_NAME} -M "${PWD}/crypto-config/organizations/peerOrganizations/${ORG_NAME}/users/Admin@${ORG_NAME}/msp" --tls.certfiles "${PWD}/ca-config/tls-cert.pem"
  { set +x; } 2>/dev/null
